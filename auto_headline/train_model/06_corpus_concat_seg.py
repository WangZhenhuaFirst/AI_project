...
def concat_txt():
    ...
    # 读取中文wiki语料
    corpus_zhwiki = pd.read_csv(
        '04_corpus.zhwiki.segwithb.txt', names='content')
    # 读取新闻语料
    ...
    corpus_zhwiki_news.to_csv(
        '06_corpus.zhwiki_news.segwithb.txt', header=None, index=None)
