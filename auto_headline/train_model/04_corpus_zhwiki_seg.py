...
def seg_with_jieba(infile, outfile, stopword=False):
    '''中文分词及去中文停用词主函数,segment the input file with jieba'''
...
def seg_with_jieba_main():
    ...
    parser.add_option('-i', '--input', dest='infile',
                      default='03_corpus.zhwiki.simplified.done.txt', help='input file to be segmented')
    # outfile为输出处理好的语料文件名称，默认corpus.zhwiki.segwithb.txt
    parser.add_option('-o', '--output', dest='outfile',
                      default='04_corpus.zhwiki.segwithb.txt', help='output file segmented')
