...
def remove_en_blank_main():
    ...
    parser.add_option('-i', '--input', dest='infile',
                      default='02_corpus.zhwiki.simplified.txt', help='input file to be preprocessed')
    # outfile为输出处理好的语料文件名称，默认corpus.zhwiki.simplified.done.txt
    parser.add_option('-o', '--output', dest='outfile',
                      default='03_corpus.zhwiki.simplified.done.txt', help='output file removed english and blank')
